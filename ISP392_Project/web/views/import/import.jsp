...
<html lang="vi">
    ...
    <body>
            ...
            <div class="left-panel">
                ...
                <div class="cart-actions">
                    ...
                    <button class="btn btn-primary me-2 d-flex align-items-center" id="checkoutBtn2">
                        <i class="bi bi-bag me-1"></i> Import
                    </button>
                    ...
                    <form id="checkoutForm2" action="Imports" method="post" style="display: none;">
                ...
                <div class="product-grid">
                    <c:forEach var="product" items="${products}">
                        <div class="product-card" 
                            ...
                            <div class="product-card-name">${product.name != null ? product.name : 'Không có tên sản phẩm'}</div>
        ...
        <script src="${pageContext.request.contextPath}/views/import/script.js"></script>
        ...
        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                if (toastMessage && toastMessage.trim() !== "") {
                                    ...
                                    fetch('${pageContext.request.contextPath}/Imports?action=clearToast', {
                                        method: 'POST'
                                    }).catch(error => {
