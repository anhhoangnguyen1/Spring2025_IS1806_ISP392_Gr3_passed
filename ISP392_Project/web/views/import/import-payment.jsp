...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/views/import/import-css.css">
        <style>
            body {
    ...
    <body>
            ...
            <div class="payment-container">
                <div class="payment-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>Payment</h4>
                        <a href="Imports" class="btn btn-outline-secondary">
                ...
                <form id="checkoutForm" action="Imports" method="post">
                    ...
                    <div class="summary-row">
                        ...
                        <div class="summary-row">
                            ...
                            <span id="modalTotalPayable" class="text-primary fw-bold" data-value="${totalAmount}">
                    ...
                    <div class="payment-footer">
                        <div class="payment-actions">
                            <a href="Imports" class="btn btn-outline-secondary">CANCEL</a>
        ...
        <script src="${pageContext.request.contextPath}/views/import/payment.js"></script>
        ...
        <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            // Nếu tổng tiền là dương, chuyển nó thành âm
                            if (totalAmount > 0) {
                                totalAmount = -totalAmount;
                            }

                            // Cập nhật giá trị vào input hidden để gửi trong form
                            document.getElementById('totalInput').value = totalAmount;

                            // Nếu totalAmount là âm, hiển thị màu đỏ (text-danger)
                            var totalElement = document.getElementById('modalTotalPayable');
                            totalElement.setAttribute('data-value', totalAmount);

                            if (totalAmount < 0) {
                                totalElement.classList.add("text-danger");  // Thêm màu đỏ cho giá trị âm
                            } else {
